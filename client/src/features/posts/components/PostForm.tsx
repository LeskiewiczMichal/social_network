...
export default function PostForm() {
  ...
  return (
    <form className="flex flex-col p-4 bg-white shadow-lg rounded-xl mx-4 md:mx-auto min-h-fit  max-w-md md:max-w-2xl mb-6 md:mb-12">
      <div className="flex flex-col md:flex-row items-start py-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            cols={30}
            rows={4}
            className="bg-gray-100 border border-primary-lighter shadow no-scrollbar resize-none rounded-xl p-2"
      ...
      file:bg-slate-150 file:text-primary
