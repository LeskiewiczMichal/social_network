...
export default function RegistrationForm() {
  ...
  return (
    <form>
      <svg
        className="fill-primary stroke-primary dark:fill-primary-lighter dark:stroke-primary-lighter mb-4"
        width="50px"
        height="50px"
        viewBox="0 -40.5 256 256"
        version="1.1"
      ...
      <div className="border-b border-gray-900/10 pb-12">
        <h2 className="font-extrabold text-2xl mt-4 mb-1 dark:text-white-dark">
          Personal Information
        </h2>
        <p className="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-dark">
