...
export default function FriendsSearchBar() {
  ...
  return (
    <div className="relative sm:h-8 flex flex-nowrap items-stretch flex-auto px-6 sm:flex-none sm:w-2/5">
      ...
      <button
        className="relative z-[2] flex items-center rounded-r-lg bg-primary px-3 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
        type="button"
        id="button-addon1"
        data-te-ripple-init
